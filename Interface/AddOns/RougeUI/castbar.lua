...
FR:SetScript("OnEvent", function(self, event)
	if event == "PLAYER_LOGIN" then
		if (RougeUI.CastTimer == true) then
			modstyle()
			FocusFrameSpellBar:HookScript("OnUpdate", function(self, elapsed) c_OnUpdate_Hook(self, elapsed) GradientColour(self) end)
			TargetFrameSpellBar:HookScript("OnUpdate", function(self, elapsed) c_OnUpdate_Hook(self, elapsed) GradientColour(self) end)
			CastingBarFrame:HookScript("OnUpdate", function(self) GradientColour(self) end)
		end
	end
