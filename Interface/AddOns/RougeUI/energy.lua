...
EnemyOOC.Quirks = {
    ...
    [91713] = true, -- Nether Ward
    [2645] = true, -- Ghost Wolf
    [36936] = true, -- Totemic Recall
    [51730] = true, -- Earthliving wep
    [8017] = true, -- Rockbiter wep
    [8232] = true, -- WF wep
    [8033] = true, -- Frostbrand wep
    [8024] = true, -- Flametongue wep
    ...
    [109742] = true, -- Find Weakness (hunter)
    [107988] = true, -- Find Weakness (hunter)
    [109744] = true, -- Find Weakness (hunter)
